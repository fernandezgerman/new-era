...
export const Checkbox = ({label, onChange, value, className, left = false, errorMessage, validMessage, checkboxClassName = ''}) => {
    return (<div className={"block min-h-6 " + className}>
        <label>
            ...
            <input
                   ...
                   checked={value}
                   className={"rounded-1 w-5 h-5 pt-[5px]" + (left ? ' ml-2 ' : ' mr-2 ') + ' ' + checkboxClassName}
                   type="checkbox"/>
