...
import {H3} from "@/components/H.jsx";
import {SubCard} from "@/components/Card.jsx";
...
import {testToken} from "@/dataAccess/ModoDeCobroSucursalConfiguracionDataAccess.jsx";
...
export const MercadoPagoModoDeCobro = ({
                                           setMercadoPagoHabilitado,
                                           mercadoPagoHabilitado,
                                           errorMessage,
                                           setToken,
                                           setUserId,
                                           checkConfigurationErrorMessage,
                                       }) => {
        ...
        {mercadoPagoHabilitado &&
            (<div className={'mt-2'}>
                <SubCard>
                    ...
                    <Input type={'text'} label={'Collector id (user id)'} className={'mt-2'} setValue={setUserId}
                           value={userId}/>
