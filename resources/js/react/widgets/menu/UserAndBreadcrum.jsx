                ...
                <ol className="flex flex-wrap pt-1 bg-transparent rounded-lg ">
                    <li className="leading-normal text-sm breadcrumb-item">
                        <a className="opacity-30 ">
                            <svg width="12px" height="12px" className="mb-1" viewBox="0 0 45 40" version="1.1"
                                ...
                                <title>shop</title>
                                <g className="fill-gray-500" stroke="none" strokeWidth="1" fill="none"
                                   fillRule="evenodd">
                                    <g className="fill-gray-500" transform="translate(-1716.000000, -439.000000)"
                    ...
                    {breadCrumbFirst &&
                        <li className="text-sm pl-2 leading-normal before:float-left before:pr-2  before:content-['/']">
                            <a> <span
                                className="opacity-50 ne-color dark:text-white">{breadCrumbFirst}</span></a>
                        </li>}
                    {breadCrumbSecond &&
                        <li className="text-sm pl-2 capitalize dark:ne-color leading-normal before:float-left before:pr-2  before:content-['/'] dark:text-white "
                            aria-current="page">{breadCrumbSecond}
                        </li>}
                </ol>
            </nav>
        </div>);
