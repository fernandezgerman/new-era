...
(function($){
	...
	$.addFlex = function(t,p)
	{
		...
		p = $.extend({
			 ...
			 title: false,
			 pagestat: 'Mostrando desde {from} hasta {to} de {total} registros',
		...
		$(g.bDiv).after(g.pDiv);
		var html = '<table class="bordesSearch"><tr class="bordesSearch"><td><div class="pGroup"><div class="pFirst pButton"><span> </span></div><div class="pPrev pButton"><span></div></div></td>'+
					'<td><div class="btnseparator"></div><div class="pGroup"><span class="pcontrol">Pagina <input class="textPagina" type="text" size="4" value="1" /> de <span> 1 </span> </span>'+
				'</div></td><td><div class="btnseparator"></div><div class="pGroup"><div class="pNext pButton"><span></span></div><div class="pLast pButton">'+
						'<span></span></div></div></td><td><div class="btnseparator"></div><div class="pGroup"><div class="pReload pButton"><span></span>'+
					'</div></div></td><td><div class="btnseparator"></div><div class="pGroup"><span class="pPageStat"></span></div></td></tr></table>';
		...
		if ($.browser.msie&&$.browser.version<7) $('.pButton',g.pDiv).hover(function(){$(this).addClass('pBtnOver');},function(){$(this).removeClass('pBtnOver');});
			...
			$('.pDiv2',g.pDiv).prepend("<div class='pGroup'><div class='divComboSearch'><select class='comboSearch'name='rp'>"+opt+"</select></div></div> <div class='btnseparator'></div>");
		...
		if (p.searchitems)
			{
				...
				$(g.sDiv).append("<div class='sDiv2'>Busqueda <input class='textQuickSearch' type='text' size='30' name='q' class='qsbox' />  <select class='comboCampos' name='qtype'>"+sopt+"</select><input type='button' name='mBuscar' value='Buscar' /> <input type='button' value='Limpiar' /></div>");

				$('input[name=q],select[name=qtype]',g.sDiv).keydown(function(e){if(e.keyCode==13) g.doSearch()});
				$('input[name=mBuscar],select[name=qtype]',g.sDiv).click(function(){g.doSearch()});
				
				
				g.doSearch()
				$('input[value=Limpiar]',g.sDiv).click(function(){$('input[name=q]',g.sDiv).val(''); p.query = ''; g.doSearch(); });
				$(g.bDiv).after(g.sDiv);				
