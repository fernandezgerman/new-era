...
Route::middleware(['auth', CheckLegacyPermissions::class, 'restrict.access.per.hour'])->group(function () {
...
Route::any('/{path}.php', [\App\Http\Controllers\Legacy\LegacyPhpController::class, 'handlePhpFile'])
    ...
    ->middleware(['auth', CheckLegacyPermissions::class, 'restrict.access.per.hour'])
