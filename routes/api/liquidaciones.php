...
route::prefix('liquidaciones')->group(function () {
    ...
    Route::get('valorizacion-historico', [\App\Http\Controllers\Liquidaciones\LiquidacionesController::class, 'getValorizacionHistorico'])
        ->name('liquidaciones.get-valorizacion-historico');
