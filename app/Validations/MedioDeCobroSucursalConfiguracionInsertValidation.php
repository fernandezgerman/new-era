 ...
 */
class MedioDeCobroSucursalConfiguracionInsertValidation
{
    /**
    ...
    public function rules(Request $request): array
    {
        ...
        return [
            ...
            'idmododecobro' => [
                ...
                // Composite uniqueness: (idsucursal, idmododecobro) must be unique
                Rule::unique('mediodecobrosucursalconfiguraciones', 'idmododecobro')
                    ->where(fn ($q) => $q->where('idsucursal', $idsucursal)),
            ],
