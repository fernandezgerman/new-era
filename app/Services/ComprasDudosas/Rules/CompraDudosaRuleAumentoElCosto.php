...
class CompraDudosaRuleAumentoElCosto implements CompraDudosaRuleInterface
{
    ...
    {
        $configEntry = 'compras-dudosas.multiplos_de_comparacion.'. TipoDeCompraDudosa::COSTO_AUMENTO_DEMASIADO->value;
        ...
        // Si el viejo costo mas la variante admitida sigue siendo mayor que el nuevo, paso la prueba
        $masIncremento = ($viejoCosto + $viejoCosto * $multiplo);
        $pass = $masIncremento > $nuevoCosto;

        return new CompraDudosaRuleResultDTO(
            $pass,
            TipoDeCompraDudosa::COSTO_AUMENTO_DEMASIADO,
            $multiplo
        );
    }
}
