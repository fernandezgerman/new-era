...
use App\Events\Events\LimiteVentaPorHoraRubro\LimiteVentaPorHoraRubroUpdatedEvent;
...
class LimiteVentaPorHoraRubroUpdatedEventListener
{
     ...
     * Handle the event.
     */
    public function handle(LimiteVentaPorHoraRubroUpdatedEvent $event): void
    {

        Log::info('event listened for update - 2');
