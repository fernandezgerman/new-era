...
use App\Events\Events\LimiteVentaPorHoraRubro\LimiteVentaPorHoraRubroDeletedEvent;
...
class LimiteVentaPorHoraRubroDeletedEventListener
{
     ...
     * Handle the event.
     */
    public function handle(LimiteVentaPorHoraRubroDeletedEvent $event): void
    {
