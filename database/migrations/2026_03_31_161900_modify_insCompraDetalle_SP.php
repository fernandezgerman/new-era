...
return new class extends Migration
{
 ...
 CREATE PROCEDURE `insCompraDetalle`(IN `p_idcabecera` BIGINT(20),
                                    ...
                                    IN `p_precio_actualizacion` decimal(15,2)
                                    )
BEGIN
...
DECLARE v_costoanterior decimal(15,2);
DECLARE v_totalfactura decimal(15,2);

DECLARE v_totalimpuestos decimal(15,2);
DECLARE v_totaldescuentos decimal(15,2);
DECLARE v_totallineaconimp DECIMAL(15,2);
DECLARE v_totallineacondesc DECIMAL(15,2);
