...
declare v_costo_con_impuestos DECIMAL(20, 3);

SELECT costo, idcompradetalle INTO v_costo_anterior, v_iddetalle_compra_anterior FROM articulos where id = p_id;


set v_costo_con_impuestos = p_costo;

if(not p_compra_detalle_id IS NULL ) then
	# aplica el costo con impuesto de la compra
	SELECT importe into v_costo_con_impuestos FROM costoscompra  WHERE idtipocosto = 1 and iddetalle = p_compra_detalle_id limit 1;
end if;
